...
export const OPServerOrderPlacing = () => {
    ...
    function initControl(responceData) {
        ...
        const MenuList = responceData.menuList.map((item) => ({
            m_key: item._id,
            m_value: { menu: item.menuItem, price: item.price }
        }))
        ...
        let ctlArray = [
            ...
            },
            {
                ...
                arrayindex: 9,
                csstheme: {
                    labletext: "Customization",
                    classname: "form-control",
                    id: "num_mod",
                    length: 50,
                    readonly: false,
                    hinttext: "Enter your Customization",
                },
                inputvalue: "",
                tooltip: {
                    place: "bottom",
    ...
    function fnTableOrderList(index, rowmode, rowaction) {
        if (rowaction === 2) {
            ...
            ctlAttribute.current[9].inputvalue = t_data[2].t_value
            setAddOrder(true);
        }
    }
    ...
    function fnConfirmOrder() {
        ...
        let err = [];
        let l_validate = [];
        err.push(validate(ctlAttribute.current[9]));
        ...
        if (canFormSubmit === false) {
            ...
            let l_tableValues = [
                ...
                {
                    t_key: 2,
                    t_value: ctlAttribute.current[9].inputvalue,
                },
            ]
            ...
            ctlAttribute.current[9].inputvalue = "";
            setAddOrder(false);
        }
    }
    ...
    function handleButtonClick(e) {
        ...
        switch (btn_id) {
            case "btn_addorder":
                ...
                tbl_menu.current.tableindex = 0;
                console.log(tbl_menu.current.tableData)
                setAddOrder(true)
                break;
            case "btn_cross":
            case "blurdiv":
            ...
            case "btn_cancel_search":
                ...
                ctlAttribute.current[9].inputvalue = "";
                ctlAttribute.current[9].error.errorshow = false;
                setAddOrder(false)
                break;
    ...
    function handleShowMenu() {
        ...
        ctlBench.current.groupbtnselectedname = 'New Order';
        tbl_menu.current.grpbtnrowid = null
        tbl_menu.current.tableData = [];
        setSideBar(true);
    }
                                            ...
                                            <div className="card">
                                                <div className="card-body" id='card-body'>
                                                    <div className='border-bottom mb-3 pb-3'>
                                                        ...
                                                        <p>View the Order status that you want</p>
                                                    </div>
                                                    <>
                                                        <button style={{ border: "none", backgroundColor: "transparent", fontSize: "200px", width: "100%", fontWeight: "lighter" }} id='addbutton' onClick={handleShowMenu}>
                                                            <i className="ti ti-octagon-plus" style={{ opacity: 0.5 }}></i>
                                                        </button>
                                                    </>
                                                </div>
                                            </div>
                                ...
                                <div className="modal-content" style={{ height: "400px" }}>
                                    ...
                                    <div className="modal-body">
                                        <div className="row">
                                            ...
                                            <div className='modal-btn text-end' style={{ marginTop: "85px" }}>
                                                <div className="mb-3">
                                                    <OPButton
