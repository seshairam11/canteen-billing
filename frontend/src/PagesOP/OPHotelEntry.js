                            ...
                            <div className='d-flex justify-content-center flex-wrap overflow-auto p-4 w-50 bg-backdrop'>
                                <div className='flex-fill'>
                                    <div className='mx-auto'>
                                        ...
                                        <div className='mb-4'>
                                            <h4>Canteen</h4>
                                            <p>This is a Page for Canteen's </p>
                                        </div>
                                    ...
                                    <p className='subtitle-entry'>Click here, If you are have a already been Canteen</p>
                                    <div className='mx-auto '>
                                        <div className='d-grid mx-auto'>
                                            <OPButton
                                    ...
                                    <p className='subtitle-entry'>Click here, If you Want to Canteen to join with us</p>
                                </div>
                            </div>
                        </div>
                    </div>
