...
export const OPAdminOrderStatus = () => {
    ...
    useEffect(() => {
        ...
        socketRef.current.emit('joinAdminOrderStatus', "mgr-orderup");

        // Listen for the 'menuList' event from the server
        socketRef.current.on('sendAdminOrderStatus', (responseData) => {
                                            ...
                                            <div className="card">
                                                <div className="card-body" id='card-body'>
                                                    <div className='border-bottom mb-3 pb-3'>
                                                        ...
                                                        <p>Total number of orders placed so far.</p>
                                                    </div>
                                                    <OPGroupButton
