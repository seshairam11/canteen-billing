                                ...
                                <div className='offcanvas-body'>
                                    ...
                                    <div className="mt-2 d-flex" >
                                        <h6 style={{ marginLeft: "27rem" }}>
                                            <span style={{ marginLeft: "2rem" }}>GST@ 18%  &nbsp; :&nbsp; </span>{(price_Total.current / 18).toFixed(2)}
                                        </h6>
                                    </div>
                                    <div className="d-flex" >
                                        <h3 style={{ marginLeft: "27rem" }}>
                                            <span style={{ marginLeft: "2rem" }}>Total &nbsp; : </span>{(price_Total.current / 18 + price_Total.current).toFixed(2)}
                                        </h3>
                                    </div>
