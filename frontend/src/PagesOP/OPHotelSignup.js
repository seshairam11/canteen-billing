        ...
        let ctl_array = [
            {
                ...
                csstheme: {
                    ...
                    length: 50,
                    readonly: false,
                    hinttext: "Enter your User Name that want to be Registor in Our Website",
                },
                inputvalue: "",
                tooltip: {
                    place: "bottom",
                            ...
                            <div className='d-flex justify-content-center flex-wrap p-4 w-50 bg-backdrop'>
                                <div className='flex-fill'>
                                    <div className='mx-auto'>
                                        ...
                                        <div className='mb-4'>
                                            <h4>Canteen</h4>
                                            <p>This page is used to Signup & Create an New Account for Canteen </p>
                                        </div>
                                        <div className='mb-3'>
                                            {/*txt:Hotel Name : 0*/}
                                            <OPTextBox
